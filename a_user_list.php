...
<!--1 Kods, kas no datubāzes dabū informāciju par lietotājiem un 
    ģenerē lietotāju sarakstu tabulas veidā no datubāzes -->
...
?>
    ...
    <?php
    	$list_query = mysqli_query($con, "SELECT ID, Vards, Uzvards, Lietotaja_limenis, Aktivs FROM 
            lietotajs WHERE Lietotaja_limenis<>'3' ORDER BY Lietotaja_limenis DESC");
    ...
    if($empty_list==1)
        echo'<tr><td colspan="3" class="td-center">Nav piesaistīts neviens lietotājs</td></tr>';
    ?>
</table>
