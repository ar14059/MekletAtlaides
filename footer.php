    ...
    <footer>
        <section id="footer" class="main-content-center">
            <section class="sub-content one">
                <a href="par_mums.php"><p class="title">Par mums</p></a><br>
                <hr class="under-title">
                <div>
                    <p class="footer-info"><a href="par_mums.php">Kas ir ...?</a></p>
                    <p class="footer-info"><a href="par_mums.php">Kā mēs strādājam?</a></p>
                </div>
            </section>
